...
export const PERMISSION_TOGGLE_DEFINITIONS: PermissionToggleDefinition[] = [
  ...
  { key: "fn_manage_founder_info", label: "Function: Manage Founder Info", group: "functions" },
  { key: "fn_manage_dev_profile", label: "Function: Manage Developer Profile", group: "functions" },
