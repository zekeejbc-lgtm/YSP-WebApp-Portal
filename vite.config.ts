  ...
  plugins: [
      ...
      manifest: {
        ...
        shortcuts: [
          ...
          },
          {
            name: 'Contact',
            short_name: 'Contact',
            description: 'Get in touch with YSP Tagum',
            url: '/#contact',
            icons: [{ src: '/icons/pwa-192x192.png', sizes: '192x192', type: 'image/png' }],
          },
        ],
    ...
    resolve: {
      ...
      alias: {
        ...
        'figma:asset/d6cbed267130c24f547c8147563471206c8f2142.png': path.resolve(__dirname, './src/assets/d6cbed267130c24f547c8147563471206c8f2142.png'),
